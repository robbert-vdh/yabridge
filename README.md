...
Yabridge has been tested under the following hosts using Wine Staging 8.18.

| Host                       | VST2               | VST3                                                                 | CLAP                                                 |
| -------------------------- | ------------------ | -------------------------------------------------------------------- | ---------------------------------------------------- |
| Bitwig Studio 5.0/5.1 beta | :heavy_check_mark: | :heavy_check_mark:                                                   | :heavy_check_mark:                                   |
