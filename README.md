...
- [:star: Usage](#usage)
  ...
  - [:star: Automatic setup (recommended)](#automatic-setup-recommended)
  ...
  - [Configuration](#configuration)
    ...
    - [Example](#example)
- [:star: Troubleshooting common issues](#troubleshooting-common-issues)
- [:star: Performance tuning](#performance-tuning)
- [:star: Runtime dependencies and known issues](#runtime-dependencies-and-known-issues)
- [Building](#building)
...
| REAPER 6.27         | :heavy_check_mark: | :heavy_check_mark:                                                        |
