...
| LMMS 1.3.0-alpha.1.568+g1f5f28fd8 | :heavy_check_mark: Some VST2 plugins might take a while to load.(VST 3 can be used through carla but Carla Patchbay/rack plugins are only supported via the latest stable version of LMMS.) | Does not support VST3, but supports VST2. | Does not support CLAP                                |
