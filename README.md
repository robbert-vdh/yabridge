...
Yabridge has been tested under the following hosts using Wine Staging 7.10:

| Host                           | VST2               | VST3                                                                 |
| ------------------------------ | ------------------ | -------------------------------------------------------------------- |
| Bitwig Studio 4.2.5/4.3 beta\* | :heavy_check_mark: | :heavy_check_mark:                                                   |
| REAPER 6.59                    | :heavy_check_mark: | :heavy_check_mark:                                                   |
