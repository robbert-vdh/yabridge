...
Yabridge has been tested under the following hosts using Wine Staging 8.5.

| Host                              | VST2               | VST3                                                                 | CLAP                                                 |
| --------------------------------- | ------------------ | -------------------------------------------------------------------- | ---------------------------------------------------- |
| Bitwig Studio 4.4.10/5.0 beta 2\* | :heavy_check_mark: | :heavy_check_mark:                                                   | :heavy_check_mark:                                   |
